...
def about
    ...
    A highly agile mid-engine track and road car with a 4.0-litre flat 
    six-cylinder naturally aspirated engine with a 9000 RPM limit and 368kW of power."
end
#Show Price
def base_price
    puts "The Pocer Primacara 4SRGT has a starting price of $310,000 plus options."
end